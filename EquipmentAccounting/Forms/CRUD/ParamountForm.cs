...
public class ParamountForm : CrudForm<Paramount>
{
    public ParamountForm() : base("Paramount")
    {
    }

    protected override void LoadData()
    {
        dataGridView.DataSource = context.Paramounts.ToList();
    }
    ...
    protected override void BtnEdit_Click(object sender, EventArgs e)
    {
        ...
        {
            var film = dataGridView.CurrentRow.DataBoundItem as Paramount;
    ...
    protected override void BtnDelete_Click(object sender, EventArgs e)
    {
        if (dataGridView.CurrentRow != null)
        {
            ...
            {
                context.Paramounts.Remove(film);
                context.SaveChanges();
                LoadData();
            }
        }
    ...
    protected override void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        var results = context.Paramounts
