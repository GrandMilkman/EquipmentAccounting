...
{
    public class BelarusfilmForm : CrudForm<Belarusfilm>
    {
        public BelarusfilmForm() : base("Беларусьфильм")
        {
        }

        protected override void LoadData()
        {
            dataGridView.DataSource = context.Belarusfilms.ToList();
        }
        ...
        protected override void BtnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                var film = dataGridView.CurrentRow.DataBoundItem as Belarusfilm;
        ...
        protected override void BtnDelete_Click(object sender, EventArgs e)
        {
            if (dataGridView.CurrentRow != null)
            {
                ...
                {
                    context.Belarusfilms.Remove(film);
                    context.SaveChanges();
                    LoadData();
                }
            }
        ...
        protected override void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            var results = context.Belarusfilms
