...
public class FPLForm : CrudForm<FPL>
{
    public FPLForm() : base("FPL")
    {
    }

    protected override void LoadData()
    {
        dataGridView.DataSource = context.FPLs.ToList();
    }
    ...
    protected override void BtnEdit_Click(object sender, EventArgs e)
    {
        ...
        {
            var film = dataGridView.CurrentRow.DataBoundItem as FPL;
