...
public class VolgaForm : CrudForm<Volga>
{
    public VolgaForm() : base("Вольга")
    {
    }

    protected override void LoadData()
    {
        dataGridView.DataSource = context.Volgas.ToList();
    }
    ...
    protected override void BtnEdit_Click(object sender, EventArgs e)
    {
        ...
        {
            var film = dataGridView.CurrentRow.DataBoundItem as Volga;
